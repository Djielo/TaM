...
(function tamCloudSupabaseModule() {
  ...
  const LS_READER_INTRO = "tam_cloud_reader_intro_v1";
  ...
  function tamCloudMaybeShowReaderIntro() {
    ...
    if (typeof tamAppAlert === "function") {
      tamAppAlert(
        "Repères, zones et réglages partagés se mettent à jour automatiquement depuis le cloud (téléphone maître). Vous n’avez pas besoin de les créer sur cet appareil.",
      );
    }
  }
